...
#define CY_CFG_SYSCLK_CLKHF5_DIVIDER CY_SYSCLK_CLKHF_DIVIDE_BY_8
#define CY_CFG_SYSCLK_CLKHF5_FREQ_MHZ 1UL
...
#define CY_CFG_SYSCLK_CLKPATH5_SOURCE CY_SYSCLK_CLKPATH_IN_WCO
...
#define CY_CFG_SYSCLK_PLL1_FEEDBACK_DIV 59
#define CY_CFG_SYSCLK_PLL1_REFERENCE_DIV 2
#define CY_CFG_SYSCLK_PLL1_OUTPUT_DIV 16
#define CY_CFG_SYSCLK_PLL1_LF_MODE false
#define CY_CFG_SYSCLK_PLL1_OUTPUT_MODE CY_SYSCLK_FLLPLL_OUTPUT_AUTO
#define CY_CFG_SYSCLK_PLL1_OUTPUT_FREQ 14750000
...
#endif //((!CY_CPU_CORTEX_M4) || (!defined(CY_DEVICE_SECURE)))
#if ((!CY_CPU_CORTEX_M4) || (!defined(CY_DEVICE_SECURE)))
	static const cy_stc_pll_manual_config_t ADC_CLKIN_PLL_pllConfig = 
	{
		.feedbackDiv = 59,
		.referenceDiv = 2,
		.outputDiv = 16,
...
__WEAK void cycfg_ClockStartupError(uint32_t error)
{
	...
	__STATIC_INLINE void Cy_SysClk_ClkHf5Init()
	{
	    ...
	    Cy_SysClk_ClkHfSetDivider(CY_CFG_SYSCLK_CLKHF5, CY_SYSCLK_CLKHF_DIVIDE_BY_8);
	...
	{
	    if (CY_SYSCLK_SUCCESS != Cy_SysClk_PllManualConfigure(2U, &ADC_CLKIN_PLL_pllConfig))
	    {
	        cycfg_ClockStartupError(CY_CFG_SYSCLK_PLL_ERROR);
	    }
